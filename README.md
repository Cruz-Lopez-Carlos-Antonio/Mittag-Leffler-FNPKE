...
```
   ...
   1.920000000000000   1.112902830756888  32.187299487468209
   1.930000000000000   1.113754021882661  32.189985679061110
   1.940000000000000   1.114607124220806  32.192691194350111
   1.950000000000000   1.115462139408038  32.195416066233641
   1.960000000000000   1.116319069163187  32.198160327626461
   1.970000000000000   1.117177915285602  32.200924011461666
   1.980000000000000   1.118038679653578  32.203707150692679
   1.990000000000000   1.118901364222842  32.206509778295207
   2.000000000000000   1.119765971025066  32.209331927269169
```
...
$$C(t)=\frac{\beta}{\Lambda}\sum_{i=1}^{2}\frac{\left(n\left(0\right)\left(r_i+\lambda\right)+\lambda C\left(0\right)\right)}{2\left(r_i\right)+\left(\frac{\lambda\Lambda-\rho+\beta}{\Lambda}\right)}\ \frac{e^{r_it}-e^{-\lambda t}}{r_i+\lambda}+C\left(0\right)e^{-\lambda t}$$
